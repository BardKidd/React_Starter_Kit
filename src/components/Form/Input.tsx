 ...
 */
const Input = (props: { title: string; formikType: string; formik: any; placeholder?: string; type?: string }) => {
  const { title, formikType, formik, placeholder, type = 'text' } = props;
  return (
    <div className="todo-mb-4">
      <p className="todo-font-bold todo-font-text-sm todo-leading-5 todo-mb-1">{title}</p>
      <input
